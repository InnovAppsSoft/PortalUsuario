package cu.suitetecsa.nautanav.ui.components.timepicker
...
fun TimerPicker(
    time: Pair<Int, Int>,
    onSelectedTime: (Pair<Int, Int>) -> Unit,
    onCancel: () -> Unit
) {
    ...
    Column(
        ...
        Row(
            ...
            TextButton(
                onClick = { onSelectedTime(Pair(selectedHour, selectedMinute)) },
                modifier = Modifier
                    .width(36.dp)
                    .height(32.dp)
            ) {
