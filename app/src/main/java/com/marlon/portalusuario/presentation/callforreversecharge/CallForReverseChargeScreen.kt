package com.marlon.portalusuario.presentation.callforreversecharge
...
@Composable
fun CallForReverseChargeScreen(onBack: () -> Unit = {}) {
                        ...
                        if (cursor.moveToFirst()) {
                            ...
                            if (cleaned.length >= 7) {
                                ...
                                if (denied) {
                                    ...
                                    val prefix = getCallPrefix(context)
                                    context.startActivity(
                                        Intent(Intent.ACTION_CALL).apply {
                                            data = Uri.parse("tel:$prefix$cleaned")
                                        },
                                    )
                                }
                            } else {
    ...
    Scaffold(
        ...
        Column(
            ...
            Text(
                text = "Selecciona un contacto para\nllamada por cobrar",
            ...
            Button(
                ...
                colors = ButtonDefaults.buttonColors(containerColor = VibrantTangerineOrange),
            ) {
