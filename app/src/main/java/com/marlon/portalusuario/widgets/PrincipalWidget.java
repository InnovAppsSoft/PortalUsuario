...
public class PrincipalWidget extends AppWidgetProvider {
    ...
    static void updateAppWidget(Context context, AppWidgetManager appWidgetManager, int i) {
        ...
        PendingIntent activity1 = PendingIntent.getActivity(context, 0, intent, PendingIntent.FLAG_IMMUTABLE);
        PendingIntent activity2 = PendingIntent.getActivity(context, 0, new Intent(context, ActivityMain.class), PendingIntent.FLAG_IMMUTABLE);
        PendingIntent broadcast = PendingIntent.getBroadcast(context, 0, intent1, PendingIntent.FLAG_IMMUTABLE);
        PendingIntent activity3 = PendingIntent.getActivity(context, 0, new Intent(context, Llamada_99Activity.class), PendingIntent.FLAG_IMMUTABLE);
        PendingIntent activity4 = PendingIntent.getActivity(context, 0, getIntent(context), PendingIntent.FLAG_IMMUTABLE);
        PendingIntent activity5 = PendingIntent.getActivity(context, 0, new Intent(context, ActivityMain.class), PendingIntent.FLAG_IMMUTABLE);
        PendingIntent activity6 = PendingIntent.getActivity(context, 0, new Intent(context, LlamadaOcultoActivity.class), PendingIntent.FLAG_IMMUTABLE);
        PendingIntent activity7 = PendingIntent.getActivity(context, 0, intent2, PendingIntent.FLAG_IMMUTABLE);
