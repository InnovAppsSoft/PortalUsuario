...
class WidgetActivity : AppCompatActivity() {
    ...
    private fun prepareConfigArea() {
        ...
        autoStartOnBoot.setOnCheckedChangeListener { _, isChecked ->
            val pref = PreferenceManager.getDefaultSharedPreferences(this@WidgetActivity)
        ...
        hideCheckbox.setOnCheckedChangeListener { _, isChecked ->
            val pref1 = PreferenceManager.getDefaultSharedPreferences(this@WidgetActivity)
        ...
        logCheckbox.setOnCheckedChangeListener { _, isChecked ->
            val pref12 = PreferenceManager.getDefaultSharedPreferences(this@WidgetActivity)
        ...
        interpolateCheckBox.setOnCheckedChangeListener { _, isChecked ->
            val pref13 = PreferenceManager.getDefaultSharedPreferences(this@WidgetActivity)
