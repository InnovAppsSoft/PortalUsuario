...
public class UserInfo extends AppCompatActivity {
    ...
    public void transfer(View v) {
        ...
        if (validate != 1) {
            if (credit.equals("$0,00 CUC")) {
                AlertDialog.Builder builder = new AlertDialog.Builder(UserInfo.this);
                builder.setTitle("Portal Usuario").setMessage("Su saldo no es suficiente!");
                builder.setPositiveButton("OK", null);
                AlertDialog success = builder.create();
                success.setCancelable(false);
                success.show();
    ...
    public void onBackPressed() {
        androidx.appcompat.app.AlertDialog.Builder builder=new androidx.appcompat.app.AlertDialog.Builder(UserInfo.this);
        ...
        builder.setPositiveButton("Menú Príncipal",new UserInfo.MyListener());
    ...
    public class MyListener implements DialogInterface.OnClickListener{
        ...
        public void onClick(DialogInterface dialog, int which) {
            startActivity(new Intent(UserInfo.this, Main3Activity.class).setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP));
        }
    }
}
