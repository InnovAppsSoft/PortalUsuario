    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (initialIntent != null){
            if (initialIntent.hasExtra("max_time")){
                maxTime = initialIntent.getExtras().getInt("max_time", 0);
            }
            if (initialIntent.hasExtra("time_type")){
                timeType = initialIntent.getExtras().getString("time_type");
            }
            my_user = (User) initialIntent.getExtras().getSerializable("user");
        }
        //
