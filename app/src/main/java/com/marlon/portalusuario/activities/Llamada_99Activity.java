...
public class Llamada_99Activity extends AppCompatActivity {
        ...
        protected void onCreate(Bundle _savedInstanceState) {
            ...
            setContentView(R.layout.activity_llamada_99);
                    ...
                    if (cursor.moveToFirst()) {
                        ...
                        if (union.length() == 8) {
                            ...
                            if (ewq.equals("5")) {
                                ...
                                Toast.makeText(Llamada_99Activity.this, error, Toast.LENGTH_SHORT).show();
                            }
                                ...
                                if (cuantos_caracteres == 14) {
                                    ...
                                    if (cuantos_caracteres == 10) {
                                        ...
                                        if (cuantos_caracteres < 8) {
                                            ...
                                            Toast.makeText(Llamada_99Activity.this, error2, Toast.LENGTH_SHORT).show();
                                        } else {
                                            Toast.makeText(Llamada_99Activity.this, error, Toast.LENGTH_SHORT).show();
                                        }
                                    }
                        ...
                        if (numero_llamar.equals("")) {
                            ...
                            final SharedPreferences share_99 = getSharedPreferences("share_99", Activity.MODE_PRIVATE);


                            if (share_99.getString("key99", "").equals("") || share_99.getString("key99", "").equals("null")) {

                                i.setData(Uri.parse("tel:*99" + numero_llamar));

                            } else {
                                if (share_99.getString("key99", "").equals("1")) {
                                    i.setData(Uri.parse("tel:*99" + numero_llamar));
                                } else {
                                    if (share_99.getString("key99", "").equals("2")) {
                                        i.setData(Uri.parse("tel:*+99" + numero_llamar));
                                    } else {
                                        if (share_99.getString("key99", "").equals("3")) {
                                            i.setData(Uri.parse("tel:+539953" + numero_llamar));
